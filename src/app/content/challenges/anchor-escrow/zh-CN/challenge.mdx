...
**注意**：如果您不熟悉 Anchor，建议先阅读 [Anchor for Dummies](/zh-CN/courses/anchor-for-dummies)，以熟悉我们将在此程序中使用的核心概念。
...
由于我们使用了 `anchor-spl`，因此还需要更新 `programs/Kiloshift_anchor_escrow/Cargo.toml` 文件，在 `idl-build` 功能中包含 `anchor-spl/idl-build`。
