...
Оскільки ми використовуємо `anchor-spl`, нам також потрібно оновити файл `programs/Kiloshift_anchor_escrow/Cargo.toml`, щоб включити `anchor-spl/idl-build` у функцію `idl-build`.
