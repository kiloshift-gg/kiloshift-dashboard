...
<ArticleSection name="Kiloshift Sandbox Environment" id="Kiloshift-sandbox-environment" level="h2" />

The challenge is designed to be completed in the **Kiloshift Sandbox Environment**.
