...
如果您是指令自省的新手，我们建议从[指令自省课程](/zh-CN/courses/instruction-introspection)开始，以了解本程序中使用的基本概念。
...
```bash
# create workspace
cargo new Kiloshift_pinocchio_flash_loan --lib --edition 2021
cd Kiloshift_pinocchio_flash_loan
```
...
`lib.rs`中的入口点与我们在[Pinocchio 入门课程](/zh-CN/courses/introduction-to-pinocchio)中介绍的内容非常相似。
