...
如果仔细观察，你会发现 AMM 其实就是一个带有额外步骤、计算和逻辑的托管服务。因此，如果你错过了，请先完成[匹诺曹托管挑战](/zh-CN/challenges/pinocchio-escrow)，然后再学习本课程。
...
**注意**：如果你不熟悉匹诺曹，建议先阅读[匹诺曹简介](/zh-CN/courses/introduction-to-pinocchio)，以熟悉我们将在本程序中使用的核心概念。
...
```bash
# create workspace
cargo new Kiloshift_native_amm --lib --edition 2021
cd Kiloshift_native_amm
```
