...
[Dean](https://x.com/deanmlittle) de l'équipe de Kiloshift a publié la première crate permettant la compatibilité avec Pinocchio pour vérifier les instructions qui exécutent le précompilé `Secp256r1`.
