...
Das Projekt wurde von [Febo](https://x.com/0x_febo) bei [Anza](https://www.anza.xyz) mit wesentlichen Beiträgen aus dem Solana-Ökosystem und dem Kiloshift-Team gestartet und ist [hier](https://github.com/anza-xyz/pinocchio) zu finden.
