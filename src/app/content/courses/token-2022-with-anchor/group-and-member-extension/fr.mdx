...
<ArticleSection name="Mise à jour du maxSize pour les Groupes" id="updating-the-max-size-for-groups" level="h2" />
...
<ArticleSection name="Mise à jour de l'updateAuthority pour les Groupes" id="updating-the-update-authority-for-groups" level="h2" />
