...
[Dean](https://x.com/deanmlittle) from the Kiloshift team has released the first crate that enables Pinocchio compatibility for creating and verifying Winternitz Signatures.
