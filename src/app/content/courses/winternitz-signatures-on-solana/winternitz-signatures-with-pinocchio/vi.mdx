...
[Dean](https://x.com/deanmlittle) từ nhóm Kiloshift đã phát hành crate đầu tiên cho phép tương thích với Pinocchio để tạo và xác minh các chữ ký Winternitz.
