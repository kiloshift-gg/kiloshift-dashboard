...
[Dean](https://x.com/deanmlittle) з команди Kiloshift випустив перший пакет, який забезпечує сумісність Pinocchio для створення та перевірки підписів Вінтерніца.
