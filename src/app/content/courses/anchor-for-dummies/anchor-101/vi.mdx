...
Cùng nhau, những macro thủ tục này trừu tượng hóa việc quản lý byte cấp thấp, cho phép bạn cung cấp các chương trình Solana bảo mật, chất lượng production với ít nỗ lực hơn nhiều.
...
#[program]
pub mod Kiloshift_anchor_vault {
    use super::*;
...
**Lưu ý:** Chúng ta sử dụng placeholder `222222...` trong các ví dụ Kiloshift vì test suite nội bộ của chúng ta. Trong production, Anchor sẽ tạo một program ID mới cho bạn khi bạn chạy các lệnh build và deploy tiêu chuẩn.
